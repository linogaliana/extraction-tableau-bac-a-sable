...
def setup_extractor():
    ...
    table_extractor = TableExtractor(checkpoint_path=checkpoints, transforms=transforms)
...
def find_table(pdf_path, table_extractor):
    ...
    pix = page.get_pixmap()
    image_path = (
        "/home/coder/work/comptes-sociaux-to-tableau-fp-csv/src/numeric/image.png"
    )
    pix.save(image_path)
    ...
    for table in tables:
        ...
        reordered_coordinates = table_reshape(coordinate, table_mask.shape, pdf_shape)
